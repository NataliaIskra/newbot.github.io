    ...
    'verdikt4': {
        ...
        'text': (
            ...
            'Как поможет трекер: Как методолог. Мы сфокусируемся на том, чтобы каждый ваш шаг превращался не только в деньги, но и в элемент будущей системы. Это позволит вам постепенно выходить из операционки, не теряя в качестве, и направить свое время на стратегию.\n\n'
                        'Предложение: Первый шаг — диагностическая сессия (1.5 часа). На ней мы определим основное ограничение, мешающее вам расти. Далее вы будете последовательно "расшивать" узкие места в вашей системе, в то числе передавая все больше функций команде и контролируя результат.'
        )
    },
    'verdikt5': {
        ...
        'text': (
            ...
            'Предложение: Предлагаю провести диагностическую сессию (1.5 часа). На ней мы определим те самые ключевые ограничения, которые мешают стабилизировать управление бизнесом. Вы сможете построить системуню работу, вовзращая в бизнес стабильность и предстказуемость и как финальный результат - достижение своих целей'
        )
    }
}
